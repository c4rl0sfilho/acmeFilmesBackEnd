    ...
    try {
        ...
        if (String(contentTypeL).toLowerCase() == 'application/json') {
            ...
            if (validarId.length > 0) {
                ...
                if (
                    novosDados.nome == '' || novosDados.nome == undefined || novosDados.nome == null || novosDados.nome.length > 80 ||
